...
const Categories = () => {
  return (
    <div className='border-b-2 py-20 mx-2 md:mx-0'>
        ...
        <div className='text-3xl md:text-5xl font-semibold py-10'>
            Browse By Category
        </div>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 '>
            <div  className='border-2 px-28 md:px-16 py-9 text-center'>
            ...
            <div className='border-2 px-28 md:px-16 py-9 text-center bg-primary'>
