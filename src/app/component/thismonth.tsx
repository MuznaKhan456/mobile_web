    ...
    return (
        <div className='mx-2 md:mx-0'>
            ...
            <div className='flex justify-between py-10'>
                ...
                <div>
                    <button className='bg-primary py-0 md:py-2 px-3 md:px-6 rounded-sm text-white'>View All</button>
                </div>
            </div>
            ...
            <div className='md:flex justify-around bg-black mt-20 md:mt-40 bg-cover pl-1 md:pl-0'>
                <div className='py-9'>
                    <h3 className='text-green-500'>Categories</h3>
                    <h2 className='text-white text-4xl md:text-5xl font-semibold pt-5'>Enhance Your</h2>
                    <h2 className='text-white text-4xl md:text-5xl font-semibold py-2'>Music Experience</h2>
        
                    <div className=' gap-2 flex  md:gap-4 py-6'>
                        <button className=' bg-white text-black rounded-full px-3 md:px-5 py-2 md:py-3'><span className='font-bold'>23</span><br/> Hours</button>
                        <button className=' bg-white text-black rounded-full px-4 md:px-6 py-2 md:py-3'><span className='font-bold'>05</span><br/> Days</button>
                        <button className=' bg-white text-black rounded-full px-2 md:px-3 py-3 md:py-3 text-sm'><span className='font-bold'>59</span><br/> Minutes</button>
                        <button className=' bg-white text-black rounded-full px-2 md:px-3 py-3 md:py-3 text-sm'><span className='font-bold'>35</span><br/> Seconds</button>
                    </div>
                    <button className='bg-green-500 rounded-sm px-9 py-1 mt-8 text-white ml-20 md:ml-0'>Buy Now!</button>
                </div>
                
                <div className='shadow-white pt-6'>
                    <Image src="/music.png"alt=""width={1000} height={1000} className='h- w-full pb-4'/>
                </div>
            </div>
